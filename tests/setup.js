  ...
  document.body.innerHTML = `
    ...
    <div id="main-area">
      <div id="data-panel">
        ...
        <div class="data-section-divider"></div>
          <div class="data-section" id="data-characters">
            <div class="data-section-header">
              <span class="data-section-title">Characters</span>
              <button class="data-section-toggle">−</button>
            </div>
            <div class="data-section-content" id="characters-panel">
              <div id="characters-list"></div>
              <div class="variable-add-row">
                <input id="characters-new-name" type="text" class="inspector-input" placeholder="Character name…">
                <button id="characters-add-btn" class="toolbar-btn">Add</button>
              </div>
            </div>
          </div>
      </div>
